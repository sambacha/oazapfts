...
describe('explode', () => {
  ...
  it('should explode objects', () => {
    expect(qs.explode({ author: { firstName: 'Felix', role: 'admin' } })).toEqual(
...
describe('deep', () => {
  ...
  it('should serialize nested objects', () => {
    expect(qs.deep({ author: { name: { first: 'Felix', last: 'Gnass' } } })).toEqual(
      'author[name][first]=Felix&author[name][last]=Gnass',
    );
  });
  it('should omit undefined values', () => {
